    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `px-3 py-2 rounded-md text-sm font-medium transition-colors ${
          isActive ? 'text-white bg-white/15' : 'text-slate-200 hover:text-white hover:bg-white/10'
        }`
      }
    >
      {label}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-emerald-500 to-cyan-400 grid place-items-center text-slate-900 font-extrabold">ZP</div>
